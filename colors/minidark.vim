...
let colors_name = "minidark"

hi Normal  ctermfg=231 ctermbg=232 cterm=NONE guibg=yellow
...
hi schemeSyntax ctermfg=123 ctermbg=NONE cterm=NONE
hi racketFunc ctermfg=123 ctermbg=NONE cterm=NONE
